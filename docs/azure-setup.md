...
`FABRIC_DATA_AGENT_URL`, `FABRIC_SQL_ENDPOINT`, `FABRIC_LAKEHOUSE_DATABASE` を Container App に同期します。
...
4. Container App または GitHub Actions variables に `FABRIC_SQL_ENDPOINT` / `FABRIC_DATA_AGENT_URL` / `FABRIC_LAKEHOUSE_DATABASE` を設定する
