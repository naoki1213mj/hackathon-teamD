...
| ID | 機能 | 詳細 |
|----|------|------|
| AG5-01 | 販促紹介動画生成 | Photo Avatar で販促紹介動画（casual-sitting スタイル、`ja-JP-Nanami:DragonHDLatestNeural` 音声、SSML ナレーション、冒頭ジェスチャー）を MP4/H.264 で自動生成する。企画書のサマリーを元に、ナレーション付きの紹介動画を自動作成する |
