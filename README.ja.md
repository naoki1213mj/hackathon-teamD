...
| [docs/presentation.md](docs/presentation.md) | 15分発表資料・デモチェックリスト |
...
| フロントエンド React/TS | 56 ファイル · 9,113 行 (37 TSX + 19 TS) |
| インフラ (Bicep) | 16 ファイル · 1,227 行 |
| テストカバレッジ | 68% (275 pytest · 74 vitest) |
| テストコード | 18 ファイル · 3,845 行 |
| UI コンポーネント | 33 コンポーネント |
